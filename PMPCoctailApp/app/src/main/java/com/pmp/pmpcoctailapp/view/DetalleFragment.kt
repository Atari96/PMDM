...
class DetalleFragment : Fragment(R.layout.fragment_detalle_cocktail) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        var nombre: TextView = view.findViewById(R.id.textViewDesc)
        ...
        detalleCocktailsViewModel.detalleCocktailLiveData.observe(viewLifecycleOwner){
